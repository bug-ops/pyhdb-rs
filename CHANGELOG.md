...
- **hdbconnect-mcp**: Support rmcp 1.2.0 non-exhaustive `ServerInfo` struct
...
- **python**: Replace GitHub-style admonitions (`[!TIP]`, `[!NOTE]`) with PyPI-compatible bold text in README
